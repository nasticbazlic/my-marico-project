...
const About = () => {
    const team = [
        {img: Image, name: 'Jacob Mark', job: 'CEO & Design'},
        {img: Image2, name: 'Daniel', job: 'CTO & Development'},
        {img: Image3, name: 'Ryan Trump', job: 'COO & Sales'}
    ]
    return (
        <div className='about'>
            ...
            <div className='about-missing-info'>
                <div className='about-missing-info-title'>
                    We exist to help creators <br/>
                        own their audience.
                </div>
                <div className='about-missing-info-subtitle'>
                We believe that social platforms are taking advantage of creators.<br />
                    We want to change that and help creators fight back. 
                </div>
                <div className='about-missing-info-text'>
                    <p>
                         ...
                         return (
                             <div className='about-team-list-item'>
                                <img src={img} alt='img_about' />
                                 <div className='about-team-list-item-name'>
                                     {name}
                                 </div>
                                 <div className='about-team-list-item-job'>
                                     {job}
                                 </div>
                                 <div className='about-team-list-item-twit'>
                                    Twitter <span>&#10150;</span>
                                 </div>
                             </div>
                         )
